...
# 🎮 Servant of the Lake — Community Edition

**A quiet lakeside mystery in a standalone community build.**
...
Servant of the Lake is an atmospheric narrative adventure set around a remote lakeside environment, combining exploration, environmental puzzles, and a character-driven story. This Community Edition is a standalone build distributed as a self-contained package that runs fully offline. It includes all content, requires no storefront and no additional software, and is ready to play immediately after installation.

For players who want a self-contained offline version of Servant of the Lake that installs directly on Windows PCs with no storefront required.
...
<table>
 <tr>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/3636770/1cfca511ba633cc274ce154706a448e961d9ee52/ss_1cfca511ba633cc274ce154706a448e961d9ee52.1920x1080.jpg?t=1787167955" alt="Screenshot 1" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/3636770/8a9d416b7c8062dfb244ec64e43af430fb69022c/ss_8a9d416b7c8062dfb244ec64e43af430fb69022c.1920x1080.jpg?t=1787167955" alt="Screenshot 2" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/3636770/390682f0b1f5b8bc6c7364c41683396c18dd7900/ss_390682f0b1f5b8bc6c7364c41683396c18dd7900.1920x1080.jpg?t=1787167955" alt="Screenshot 3" width="100%"></td>
 </tr>
</table>
...
- 🌊 **Atmospheric Setting** — Explore a remote lake environment with detailed art and ambient sound design.
- 📖 **Narrative Focus** — A story-driven adventure built around exploration and discovery.
- 🧩 **Environmental Puzzles** — Solve puzzles woven into the world to progress through the story.
- 🎵 **Original Soundtrack** — Original score included and fully integrated with the game.
- 🎮 **Single-Player Campaign** — Complete offline playthrough with no internet connection required.
...
- 🔧 **Configurable Options** — Adjustable graphics, audio, and control settings.
...
| **RAM** | 4 GB | 8 GB |
| **Graphics** | DirectX 11 compatible GPU, 2 GB VRAM | DirectX 11 compatible GPU, 4 GB VRAM |
| **Storage** | 5 GB available space | 5 GB available space on SSD |
| **Additional** | DirectX 11 | Headphones recommended for full audio experience |
...
> 💡 **Saves location:** `%LOCALAPPDATA%\ServantoftheLake\Saved`
